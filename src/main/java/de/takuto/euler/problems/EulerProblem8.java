...
public class EulerProblem8 implements EulerProblem {
    ...
    public String solve() {
        ...
        return "The largest product of " + WINDOW_SIZE + " adjacent numbers is: " + product;
    }
